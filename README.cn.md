...
合计: **54,704** 行代码（覆盖前 5 种语言、共 **142** 个文件）。
...
- **上游仓库**: <https://github.com/thetumultuousunicornofdarkness/CPU-X>
- **官网**: <https://thetumultuousunicornofdarkness.github.io/CPU-X>
- **许可证**: GPL-3.0
...
- **Star**: 2,652 · **Fork**: 157 · **开放 issue**: 306 · **贡献者**: 180

## 累计统计

- **发布数**: 50 · **已合并 PR**: 91 · **开放 PR**: 3 · **已关闭 issue**: 302 · **开放 issue**: 4 · **提交数**: 2828
...
CPU-X 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `CPU-X` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/CPU-X.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T19:19:32Z._
